...
import { TrendingUp, ArrowUpDown, Zap, BarChart3, Wallet, History, X, Activity } from "lucide-react";
...
export default function TradeTerminalPage() {
  ...
  const [instruments, setInstruments] = useState<BybitInstrumentSummary[]>([]);
  ...
  useEffect(() => {
    const fetchInstruments = async () => {
      try {
        ...
        const data = await getBybitInstruments();
        setInstruments(data);
      } catch (e) {
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Image src="/images/trade.png" alt="Trade Terminal" width={32} height={32} className="rounded-lg" />
              <div>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 py-4 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
          ...
          <div className="col-span-1 lg:col-span-6 flex flex-col gap-4">
            {/* Chart */}
            <div className="h-[360px] rounded-xl overflow-hidden border border-slate-800 bg-slate-950">
